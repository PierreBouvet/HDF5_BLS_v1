...
def test_create_wrapper_empty():
    ...
    print("test_create_wrapper_empty - PASS")
...
def test_create_wrapper_with_data():
    ...
    print("test_create_wrapper_with_data - PASS")
...
def test_add_data_group_to_wrapper():
    ...
    print("test_add_data_group_to_wrapper - PASS")
...
# Testing the creation of an empy wrapper
test_create_wrapper_empty()

# Testing the creation of a wrapper with data
test_create_wrapper_with_data()

# Testing the addition of data to a wrapper
test_add_data_group_to_wrapper()
